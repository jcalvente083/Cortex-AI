...
\begin{document}
    ...
    % ==================== APARTADOS ====================
    \include{apartados/1_Propuesta/propuesta}
    \include{apartados/2_EstadoArte/estadoArte}
    \include{apartados/3_Metodologia/metodologia}
    \include{apartados/4_Diseno/diseno} 
    \include{apartados/5_PruebaConcepto/pruebaConcepto}
    \include{apartados/6_Resultados/resultados}
    \include{apartados/7_Conclusiones/conclusiones}    
    ...
    \input{apartados/anexos/entornoVirtual}
    \input{apartados/anexos/repositorio}
    \input{apartados/anexos/eda}
