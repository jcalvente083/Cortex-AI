...
Dado que los requisitos de memoria gráfica de Wav2Vec 2.0 limitan el tamaño de lote físico a 4 muestras, se implementó la técnica de acumulación de gradientes (\textit{Gradient Accumulation}) \cite{ott2019} con un factor de 4 pasos, obteniendo un tamaño de lote efectivo de 16 muestras. Esta técnica acumula los gradientes de múltiples iteraciones hacia adelante (\textit{forward passes}) antes de ejecutar la actualización de pesos, emulando el comportamiento de un lote mayor sin incrementar el consumo de memoria.
