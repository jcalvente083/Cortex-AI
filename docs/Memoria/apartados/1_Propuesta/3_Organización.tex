...
\begin{itemize}
    \item En el \textbf{\hyperref[app:anexo_a]{Apéndice~\ref*{app:anexo_a}}}, se proporciona el listado completo de las dependencias del entorno virtual empleado, asegurando la reproducibilidad del entorno de desarrollo.
    \item En el \textbf{\hyperref[app:anexo_b]{Apéndice~\ref*{app:anexo_b}}}, se detalla la ubicación del repositorio público de código fuente, así como los enlaces y credenciales (mediante códigos QR) para acceder a los binarios compilados de la aplicación móvil (instalables para plataformas Android e iOS).
\end{itemize}